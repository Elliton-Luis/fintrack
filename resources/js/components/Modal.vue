<template>
    <Transition name="modal-transition">
        ...
        <div v-if="modelValue" @click="closeModal" class="fixed inset-0 z-40 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">

            <div v-if="flash?.success" class="mb-4 p-3 bg-green-600 text-white rounded">
                {{ flash.success }}
            </div>

            <div @click.stop class="modal-card w-full max-w-md flex flex-col overflow-hidden shadow-lg
